...
collapse_property_coding = pd.DataFrame({'coded_property_name': sum([['maximum_plant_height'] * 8,
                                                                   ['maximum_leaf_width'] * 4,
                                                                   ['maximum_inflorescence_length'] * 4,
                                                                   ['maximum_inflorescence_width'] * 2,
                                                                    ['maximum_fruit_length'] * 2,
                                                                    ['maximum_fruit_width'] * 2], [])
                                       , 'property_name': ['culm_size', 'culm_height', 'culm_atypical_size',
                                                           'culm_height_or_length', 'culm_length',
                                                           'culm_some_measurement', 'culm_leaf_some_measurement',
                                                           'angle_some_measurement',
                                                           'blade_size', 'blade_width', 'leaf_size', 'leaf_width',
                                                           'inflorescence_height_or_length', 'inflorescence_length',
                                                           'inflorescence_some_measurement', 'inflorescence_atypical_length',
                                                           'inflorescence_atypical_width', 'inflorescence_width',
                                                           'achene_atypical_length', 'achene_length',
                                                           'achene_atypical_width', 'achene_width']})
